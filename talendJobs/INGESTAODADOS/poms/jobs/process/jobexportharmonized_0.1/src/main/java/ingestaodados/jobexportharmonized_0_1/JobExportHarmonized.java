...
/**
 * Job: JobExportHarmonized Purpose: Export dados para a hierarquia
 * Harmonized<br>
...
public class JobExportHarmonized implements TalendJob {
	...
	public void tPostjob_5_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tPostjob_5_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "D:/DataLake/RawData/address_"
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"D:/DataLake/RawData/address_" + TalendDate.getDate("YYYY-MM-DD") + ".csv",
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											...
											"AddressID", "row4", temp, ex_tFileInputDelimited_2),
								...
								rowstate_tFileInputDelimited_2.setException(new RuntimeException(
										"Value is empty for column : 'AddressID' in 'row4' connection, value is invalid or this column should be nullable or have a default value."));
...
// Start of branch "out1"
							if (out1 != null) {
								...
								sb_tFileOutputDelimited_4.append(out1.AddressID);
								sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
								if (out1.AddressLine1 != null) {
									sb_tFileOutputDelimited_4.append(out1.AddressLine1);
								}
								sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
								if (out1.AddressLine2 != null) {
									sb_tFileOutputDelimited_4.append(out1.AddressLine2);
								}
								sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
								if (out1.StateProvince != null) {
									sb_tFileOutputDelimited_4.append(out1.StateProvince);
								}
								sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
								if (out1.CountryRegion != null) {
									sb_tFileOutputDelimited_4.append(out1.CountryRegion);
								}
								sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
								if (out1.City != null) {
									sb_tFileOutputDelimited_4.append(out1.City);
								}
								sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
								if (out1.PostalCode != null) {
									sb_tFileOutputDelimited_4.append(out1.PostalCode);
								}
					...
					if (!((Object) ("D:/DataLake/RawData/address_" + TalendDate.getDate("YYYY-MM-DD")
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_5 = (new java.io.File(
						"D:/DataLake/Harmonized/HA_customerAddress_" + TalendDate.getDate("YYYY-MM-DD") + ".csv"))
								.getAbsolutePath().replace("\\", "/");
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_3 = "D:/DataLake/RawData/customerAddress_"
							+ TalendDate.getDate("YYYY-MM-DD") + ".csv";
					...
					try {
						fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited(
								"D:/DataLake/RawData/customerAddress_" + TalendDate.getDate("YYYY-MM-DD") + ".csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"CustomerID", "row5", temp, ex_tFileInputDelimited_3),
								...
								rowstate_tFileInputDelimited_3.setException(new RuntimeException(
										"Value is empty for column : 'CustomerID' in 'row5' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"AddressID", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
								...
								rowstate_tFileInputDelimited_3.setException(new RuntimeException(
										"Value is empty for column : 'AddressID' in 'row5' connection, value is invalid or this column should be nullable or have a default value."));
...
// Start of branch "out2"
							if (out2 != null) {
								...
								sb_tFileOutputDelimited_5.append(out2.CustomerID);
								sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
								sb_tFileOutputDelimited_5.append(out2.AddressID);
								sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
								if (out2.AddressType != null) {
									sb_tFileOutputDelimited_5.append(out2.AddressType);
								}
					...
					if (!((Object) ("D:/DataLake/RawData/customerAddress_" + TalendDate.getDate("YYYY-MM-DD")
							+ ".csv") instanceof java.io.InputStream)) {
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_4 = "D:/DataLake/RawData/customer_"
							+ TalendDate.getDate("YYYY-MM-DD") + ".csv";
					...
					try {
						fid_tFileInputDelimited_4 = new org.talend.fileprocess.FileInputDelimited(
								"D:/DataLake/RawData/customer_" + TalendDate.getDate("YYYY-MM-DD") + ".csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"CustomerID", "row6", temp, ex_tFileInputDelimited_4),
								...
								rowstate_tFileInputDelimited_4.setException(new RuntimeException(
										"Value is empty for column : 'CustomerID' in 'row6' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"NameStyle", "row6", temp, ex_tFileInputDelimited_4),
											ex_tFileInputDelimited_4));
								}
								...
								rowstate_tFileInputDelimited_4.setException(new RuntimeException(
										"Value is empty for column : 'NameStyle' in 'row6' connection, value is invalid or this column should be nullable or have a default value."));
...
// Start of branch "out3"
							if (out3 != null) {
								...
								sb_tFileOutputDelimited_6.append(out3.CustomerID);
								sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
								sb_tFileOutputDelimited_6.append(out3.NameStyle);
								sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
								if (out3.Title != null) {
									sb_tFileOutputDelimited_6.append(out3.Title);
								}
								sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
								if (out3.FirstName != null) {
									sb_tFileOutputDelimited_6.append(out3.FirstName);
								}
								sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
								if (out3.MiddleName != null) {
									sb_tFileOutputDelimited_6.append(out3.MiddleName);
								}
								sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
								if (out3.LastName != null) {
									sb_tFileOutputDelimited_6.append(out3.LastName);
								}
								sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
								if (out3.Suffix != null) {
									sb_tFileOutputDelimited_6.append(out3.Suffix);
								}
								sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
								if (out3.CompanyName != null) {
									sb_tFileOutputDelimited_6.append(out3.CompanyName);
								}
								sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
								if (out3.SalesPerson != null) {
									sb_tFileOutputDelimited_6.append(out3.SalesPerson);
								}
								sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
								if (out3.EmailAddress != null) {
									sb_tFileOutputDelimited_6.append(out3.EmailAddress);
								}
								sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
								if (out3.Phone != null) {
									sb_tFileOutputDelimited_6.append(out3.Phone);
								}
					...
					if (!((Object) ("D:/DataLake/RawData/customer_" + TalendDate.getDate("YYYY-MM-DD")
							+ ".csv") instanceof java.io.InputStream)) {
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_5 = "D:/DataLake/RawData/product_"
							+ TalendDate.getDate("YYYY-MM-DD") + ".csv";
					...
					try {
						fid_tFileInputDelimited_5 = new org.talend.fileprocess.FileInputDelimited(
								"D:/DataLake/RawData/product_" + TalendDate.getDate("YYYY-MM-DD") + ".csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductID", "row7", temp, ex_tFileInputDelimited_5),
								...
								rowstate_tFileInputDelimited_5.setException(new RuntimeException(
										"Value is empty for column : 'ProductID' in 'row7' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Weight", "row7", temp, ex_tFileInputDelimited_5),
											ex_tFileInputDelimited_5));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductCategoryID", "row7", temp, ex_tFileInputDelimited_5),
											ex_tFileInputDelimited_5));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductModelID", "row7", temp, ex_tFileInputDelimited_5),
											ex_tFileInputDelimited_5));
								}
							...
							row7.DiscontinuedDate = fid_tFileInputDelimited_5
							...
							row7.ThumbnailPhotoFileName = fid_tFileInputDelimited_5
									.get(columnIndexWithD_tFileInputDelimited_5);
...
// Start of branch "out4"
							if (out4 != null) {
								...
								sb_tFileOutputDelimited_7.append(out4.ProductID);
								sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
								if (out4.Name != null) {
									sb_tFileOutputDelimited_7.append(out4.Name);
								}
								sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
								if (out4.ProductNumber != null) {
									sb_tFileOutputDelimited_7.append(out4.ProductNumber);
								}
								sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
								if (out4.Color != null) {
									sb_tFileOutputDelimited_7.append(out4.Color);
								}
								sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
								if (out4.StandardCost != null) {
									sb_tFileOutputDelimited_7.append(out4.StandardCost);
								}
								sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
								if (out4.ListPrice != null) {
									sb_tFileOutputDelimited_7.append(out4.ListPrice);
								}
								sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
								if (out4.Size != null) {
									sb_tFileOutputDelimited_7.append(out4.Size);
								}
								sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
								if (out4.Weight != null) {
								...
								if (out4.ProductCategoryID != null) {
									sb_tFileOutputDelimited_7.append(out4.ProductCategoryID);
								}
								sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
								if (out4.ProductModelID != null) {
									sb_tFileOutputDelimited_7.append(out4.ProductModelID);
								}
								sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
								if (out4.SellStartDate != null) {
									sb_tFileOutputDelimited_7.append(out4.SellStartDate);
								}
								sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
								if (out4.SellEndDate != null) {
									sb_tFileOutputDelimited_7.append(out4.SellEndDate);
								}
								sb_tFileOutputDelimited_7.append(OUT_DELIM_tFileOutputDelimited_7);
								if (out4.DiscontinuedDate != null) {
									sb_tFileOutputDelimited_7.append(out4.DiscontinuedDate);
								}
					...
					if (!((Object) ("D:/DataLake/RawData/product_" + TalendDate.getDate("YYYY-MM-DD")
							+ ".csv") instanceof java.io.InputStream)) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_8 = (new java.io.File(
						"D:/DataLake/Harmonized/HA_productCategory_" + TalendDate.getDate("YYYY-MM-DD") + ".csv"))
								.getAbsolutePath().replace("\\", "/");
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_6 = "D:/DataLake/RawData/productCategory_"
							+ TalendDate.getDate("YYYY-MM-DD") + ".csv";
					...
					try {
						fid_tFileInputDelimited_6 = new org.talend.fileprocess.FileInputDelimited(
								"D:/DataLake/RawData/productCategory_" + TalendDate.getDate("YYYY-MM-DD") + ".csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductCategoryID", "row8", temp, ex_tFileInputDelimited_6),
								...
								rowstate_tFileInputDelimited_6.setException(new RuntimeException(
										"Value is empty for column : 'ProductCategoryID' in 'row8' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ParentProductCategoryID", "row8", temp, ex_tFileInputDelimited_6),
											ex_tFileInputDelimited_6));
								}
...
// Start of branch "out5"
							if (out5 != null) {
								...
								sb_tFileOutputDelimited_8.append(out5.ProductCategoryID);
								sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
								if (out5.Name != null) {
									sb_tFileOutputDelimited_8.append(out5.Name);
								}
								sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
								if (out5.ParentProductCategoryID != null) {
									sb_tFileOutputDelimited_8.append(out5.ParentProductCategoryID);
								}
					...
					if (!((Object) ("D:/DataLake/RawData/productCategory_" + TalendDate.getDate("YYYY-MM-DD")
							+ ".csv") instanceof java.io.InputStream)) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_9 = (new java.io.File(
						"D:/DataLake/Harmonized/HA_productDescription_" + TalendDate.getDate("YYYY-MM-DD") + ".csv"))
								.getAbsolutePath().replace("\\", "/");
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_7 = "D:/DataLake/RawData/productDescription_"
							+ TalendDate.getDate("YYYY-MM-DD") + ".csv";
					...
					try {
						fid_tFileInputDelimited_7 = new org.talend.fileprocess.FileInputDelimited(
								"D:/DataLake/RawData/productDescription_" + TalendDate.getDate("YYYY-MM-DD") + ".csv",
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_7.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductDescriptionID", "row9", temp, ex_tFileInputDelimited_7),
								...
								rowstate_tFileInputDelimited_7.setException(new RuntimeException(
										"Value is empty for column : 'ProductDescriptionID' in 'row9' connection, value is invalid or this column should be nullable or have a default value."));
...
// Start of branch "out6"
							if (out6 != null) {
								...
								sb_tFileOutputDelimited_9.append(out6.ProductDescriptionID);
								sb_tFileOutputDelimited_9.append(OUT_DELIM_tFileOutputDelimited_9);
								if (out6.Description != null) {
									sb_tFileOutputDelimited_9.append(out6.Description);
								}
					...
					if (!((Object) ("D:/DataLake/RawData/productDescription_" + TalendDate.getDate("YYYY-MM-DD")
							+ ".csv") instanceof java.io.InputStream)) {
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_8 = "D:/DataLake/RawData/productModel_"
							+ TalendDate.getDate("YYYY-MM-DD") + ".csv";
					...
					try {
						fid_tFileInputDelimited_8 = new org.talend.fileprocess.FileInputDelimited(
								"D:/DataLake/RawData/productModel_" + TalendDate.getDate("YYYY-MM-DD") + ".csv",
					...
					while (fid_tFileInputDelimited_8 != null && fid_tFileInputDelimited_8.nextRecord()) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_8.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductModelID", "row10", temp, ex_tFileInputDelimited_8),
								...
								rowstate_tFileInputDelimited_8.setException(new RuntimeException(
										"Value is empty for column : 'ProductModelID' in 'row10' connection, value is invalid or this column should be nullable or have a default value."));
							...
							row10.CatalogDescription = fid_tFileInputDelimited_8
...
// Start of branch "out7"
							if (out7 != null) {
								...
								sb_tFileOutputDelimited_10.append(out7.ProductModelID);
								sb_tFileOutputDelimited_10.append(OUT_DELIM_tFileOutputDelimited_10);
								if (out7.Name != null) {
									sb_tFileOutputDelimited_10.append(out7.Name);
								}
								sb_tFileOutputDelimited_10.append(OUT_DELIM_tFileOutputDelimited_10);
								if (out7.CatalogDescription != null) {
									sb_tFileOutputDelimited_10.append(out7.CatalogDescription);
								}
					...
					if (!((Object) ("D:/DataLake/RawData/productModel_" + TalendDate.getDate("YYYY-MM-DD")
							+ ".csv") instanceof java.io.InputStream)) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_11 = (new java.io.File(
						"D:/DataLake/Harmonized/HA_productModelProductDescription_" + TalendDate.getDate("YYYY-MM-DD")
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_9 = "D:/DataLake/RawData/productModelProductDescription_"
							+ TalendDate.getDate("YYYY-MM-DD") + ".csv";
					...
					try {
						fid_tFileInputDelimited_9 = new org.talend.fileprocess.FileInputDelimited(
								"D:/DataLake/RawData/productModelProductDescription_" + TalendDate.getDate("YYYY-MM-DD")
										+ ".csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_9.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductModelID", "row11", temp, ex_tFileInputDelimited_9),
								...
								rowstate_tFileInputDelimited_9.setException(new RuntimeException(
										"Value is empty for column : 'ProductModelID' in 'row11' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_9.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductDescriptionID", "row11", temp, ex_tFileInputDelimited_9),
											ex_tFileInputDelimited_9));
								}
								...
								rowstate_tFileInputDelimited_9.setException(new RuntimeException(
										"Value is empty for column : 'ProductDescriptionID' in 'row11' connection, value is invalid or this column should be nullable or have a default value."));
...
// Start of branch "out8"
							if (out8 != null) {
								...
								sb_tFileOutputDelimited_11.append(out8.ProductModelID);
								sb_tFileOutputDelimited_11.append(OUT_DELIM_tFileOutputDelimited_11);
								sb_tFileOutputDelimited_11.append(out8.ProductDescriptionID);
								sb_tFileOutputDelimited_11.append(OUT_DELIM_tFileOutputDelimited_11);
								if (out8.Culture != null) {
									sb_tFileOutputDelimited_11.append(out8.Culture);
								}
					...
					if (!((Object) ("D:/DataLake/RawData/productModelProductDescription_"
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_12 = (new java.io.File(
						"D:/DataLake/Harmonized/HA_salesOrderDetail_" + TalendDate.getDate("YYYY-MM-DD") + ".csv"))
								.getAbsolutePath().replace("\\", "/");
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_10 = "D:/DataLake/RawData/salesOrderDetail_"
							+ TalendDate.getDate("YYYY-MM-DD") + ".csv";
					...
					try {
						fid_tFileInputDelimited_10 = new org.talend.fileprocess.FileInputDelimited(
								"D:/DataLake/RawData/salesOrderDetail_" + TalendDate.getDate("YYYY-MM-DD") + ".csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"SalesOrderID", "row12", temp, ex_tFileInputDelimited_10),
								...
								rowstate_tFileInputDelimited_10.setException(new RuntimeException(
										"Value is empty for column : 'SalesOrderID' in 'row12' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"SalesOrderDetailID", "row12", temp, ex_tFileInputDelimited_10),
											ex_tFileInputDelimited_10));
								}
								...
								rowstate_tFileInputDelimited_10.setException(new RuntimeException(
										"Value is empty for column : 'SalesOrderDetailID' in 'row12' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"OrderQty", "row12", temp, ex_tFileInputDelimited_10),
											ex_tFileInputDelimited_10));
								}
								...
								rowstate_tFileInputDelimited_10.setException(new RuntimeException(
										"Value is empty for column : 'OrderQty' in 'row12' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ProductID", "row12", temp, ex_tFileInputDelimited_10),
											ex_tFileInputDelimited_10));
								}
								...
								rowstate_tFileInputDelimited_10.setException(new RuntimeException(
										"Value is empty for column : 'ProductID' in 'row12' connection, value is invalid or this column should be nullable or have a default value."));
							...
							row12.UnitPriceDiscount = fid_tFileInputDelimited_10
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"LineTotal", "row12", temp, ex_tFileInputDelimited_10),
											ex_tFileInputDelimited_10));
								}
							...
							row12.ModifiedDate = fid_tFileInputDelimited_10
									.get(columnIndexWithD_tFileInputDelimited_10);
...
// Start of branch "out9"
							if (out9 != null) {
								...
								sb_tFileOutputDelimited_12.append(out9.SalesOrderID);
								sb_tFileOutputDelimited_12.append(OUT_DELIM_tFileOutputDelimited_12);
								sb_tFileOutputDelimited_12.append(out9.SalesOrderDetailID);
								sb_tFileOutputDelimited_12.append(OUT_DELIM_tFileOutputDelimited_12);
								sb_tFileOutputDelimited_12.append(out9.OrderQty);
								sb_tFileOutputDelimited_12.append(OUT_DELIM_tFileOutputDelimited_12);
								sb_tFileOutputDelimited_12.append(out9.ProductID);
								sb_tFileOutputDelimited_12.append(OUT_DELIM_tFileOutputDelimited_12);
								if (out9.UnitPrice != null) {
									sb_tFileOutputDelimited_12.append(out9.UnitPrice);
								}
								sb_tFileOutputDelimited_12.append(OUT_DELIM_tFileOutputDelimited_12);
								if (out9.UnitPriceDiscount != null) {
									sb_tFileOutputDelimited_12.append(out9.UnitPriceDiscount);
								}
								sb_tFileOutputDelimited_12.append(OUT_DELIM_tFileOutputDelimited_12);
					...
					if (!((Object) ("D:/DataLake/RawData/salesOrderDetail_" + TalendDate.getDate("YYYY-MM-DD")
							+ ".csv") instanceof java.io.InputStream)) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_13 = (new java.io.File(
						"D:/DataLake/Harmonized/HA_salesOrderHeader_" + TalendDate.getDate("YYYY-MM-DD") + ".csv"))
								.getAbsolutePath().replace("\\", "/");
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_11 = "D:/DataLake/RawData/salesOrderHeader_"
							+ TalendDate.getDate("YYYY-MM-DD") + ".csv";
					...
					try {
						fid_tFileInputDelimited_11 = new org.talend.fileprocess.FileInputDelimited(
								"D:/DataLake/RawData/salesOrderHeader_" + TalendDate.getDate("YYYY-MM-DD") + ".csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_11.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"SalesOrderID", "row13", temp, ex_tFileInputDelimited_11),
								...
								rowstate_tFileInputDelimited_11.setException(new RuntimeException(
										"Value is empty for column : 'SalesOrderID' in 'row13' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_11.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"RevisionNumber", "row13", temp, ex_tFileInputDelimited_11),
											ex_tFileInputDelimited_11));
								}
								...
								rowstate_tFileInputDelimited_11.setException(new RuntimeException(
										"Value is empty for column : 'RevisionNumber' in 'row13' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_11.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Status", "row13", temp, ex_tFileInputDelimited_11),
											ex_tFileInputDelimited_11));
								}
								...
								rowstate_tFileInputDelimited_11.setException(new RuntimeException(
										"Value is empty for column : 'Status' in 'row13' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_11.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"OnlineOrderFlag", "row13", temp, ex_tFileInputDelimited_11),
											ex_tFileInputDelimited_11));
								}
								...
								rowstate_tFileInputDelimited_11.setException(new RuntimeException(
										"Value is empty for column : 'OnlineOrderFlag' in 'row13' connection, value is invalid or this column should be nullable or have a default value."));

							}

							columnIndexWithD_tFileInputDelimited_11 = 7;

							row13.SalesOrderNumber = fid_tFileInputDelimited_11
									.get(columnIndexWithD_tFileInputDelimited_11);

							columnIndexWithD_tFileInputDelimited_11 = 8;

							row13.PurchaseOrderNumber = fid_tFileInputDelimited_11
									.get(columnIndexWithD_tFileInputDelimited_11);

							columnIndexWithD_tFileInputDelimited_11 = 9;

							row13.AccountNumber = fid_tFileInputDelimited_11
									.get(columnIndexWithD_tFileInputDelimited_11);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_11.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"CustomerID", "row13", temp, ex_tFileInputDelimited_11),
											ex_tFileInputDelimited_11));
								}
								...
								rowstate_tFileInputDelimited_11.setException(new RuntimeException(
										"Value is empty for column : 'CustomerID' in 'row13' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_11.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"ShipToAddressID", "row13", temp, ex_tFileInputDelimited_11),
											ex_tFileInputDelimited_11));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_11.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"BillToAddressID", "row13", temp, ex_tFileInputDelimited_11),
											ex_tFileInputDelimited_11));
								}
							...
							row13.CreditCardApprovalCode = fid_tFileInputDelimited_11
									.get(columnIndexWithD_tFileInputDelimited_11);
							...
							row13.ModifiedDate = fid_tFileInputDelimited_11
									.get(columnIndexWithD_tFileInputDelimited_11);
...
// Start of branch "out10"
							if (out10 != null) {
								...
								sb_tFileOutputDelimited_13.append(out10.SalesOrderID);
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								sb_tFileOutputDelimited_13.append(out10.RevisionNumber);
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.OrderDate != null) {
									sb_tFileOutputDelimited_13.append(out10.OrderDate);
								}
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.DueDate != null) {
									sb_tFileOutputDelimited_13.append(out10.DueDate);
								}
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.ShipDate != null) {
									sb_tFileOutputDelimited_13.append(out10.ShipDate);
								}
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								sb_tFileOutputDelimited_13.append(out10.Status);
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								sb_tFileOutputDelimited_13.append(out10.OnlineOrderFlag);
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.SalesOrderNumber != null) {
									sb_tFileOutputDelimited_13.append(out10.SalesOrderNumber);
								}
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.PurchaseOrderNumber != null) {
									sb_tFileOutputDelimited_13.append(out10.PurchaseOrderNumber);
								}
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.AccountNumber != null) {
									sb_tFileOutputDelimited_13.append(out10.AccountNumber);
								}
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								sb_tFileOutputDelimited_13.append(out10.CustomerID);
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.ShipToAddressID != null) {
									sb_tFileOutputDelimited_13.append(out10.ShipToAddressID);
								}
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.BillToAddressID != null) {
									sb_tFileOutputDelimited_13.append(out10.BillToAddressID);
								}
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.ShipMethod != null) {
									sb_tFileOutputDelimited_13.append(out10.ShipMethod);
								}
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.CreditCardApprovalCode != null) {
									sb_tFileOutputDelimited_13.append(out10.CreditCardApprovalCode);
								}
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.SubTotal != null) {
									sb_tFileOutputDelimited_13.append(out10.SubTotal);
								}
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.TaxAmt != null) {
									sb_tFileOutputDelimited_13.append(out10.TaxAmt);
								}
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.Freight != null) {
									sb_tFileOutputDelimited_13.append(out10.Freight);
								}
								sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
								if (out10.TotalDue != null) {
									sb_tFileOutputDelimited_13.append(out10.TotalDue);
								}
					...
					if (!((Object) ("D:/DataLake/RawData/salesOrderHeader_" + TalendDate.getDate("YYYY-MM-DD")
							+ ".csv") instanceof java.io.InputStream)) {
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = JobExportHarmonized.class.getClassLoader().getResourceAsStream(
					"ingestaodados/jobexportharmonized_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = JobExportHarmonized.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : JobExportHarmonized");
		}
...
/************************************************************************************************
 * 405864 characters generated by Talend Open Studio for Big Data on the 1 de
 * Maio de 2021 4h32min50s BRT
 ************************************************************************************************/