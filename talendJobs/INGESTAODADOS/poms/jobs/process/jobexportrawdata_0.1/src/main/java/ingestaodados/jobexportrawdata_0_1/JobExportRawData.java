...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("D:/DataLake/RawData/address_"+TalendDate.getDate("YYYY-MM-DD")+".csv")).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File("D:/DataLake/RawData/customer_"+TalendDate.getDate("YYYY-MM-DD")+".csv")).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_3 = "";
    fileName_tFileOutputDelimited_3 = (new java.io.File("D:/DataLake/RawData/customerAddress_"+TalendDate.getDate("YYYY-MM-DD")+".csv")).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_4 = "";
    fileName_tFileOutputDelimited_4 = (new java.io.File("D:/DataLake/RawData/product_"+TalendDate.getDate("YYYY-MM-DD")+".csv")).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_5 = "";
    fileName_tFileOutputDelimited_5 = (new java.io.File("D:/DataLake/RawData/productCategory_"+TalendDate.getDate("YYYY-MM-DD")+".csv")).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_6 = "";
    fileName_tFileOutputDelimited_6 = (new java.io.File("D:/DataLake/RawData/productDescription_"+TalendDate.getDate("YYYY-MM-DD")+".csv")).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_7 = "";
    fileName_tFileOutputDelimited_7 = (new java.io.File("D:/DataLake/RawData/productModelProductDescription_"+TalendDate.getDate("YYYY-MM-DD")+".csv")).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_8 = "";
    fileName_tFileOutputDelimited_8 = (new java.io.File("D:/DataLake/RawData/salesOrderDetail_"+TalendDate.getDate("YYYY-MM-DD")+".csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tFileOutputDelimited_8";
                    ...
                    StringBuilder sb_tFileOutputDelimited_8 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_8.append(
                            row8.UnitPriceDiscount
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row8.LineTotal != null) {
                        sb_tFileOutputDelimited_8.append(
                            row8.LineTotal.setScale(6, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
...
String fileName_tFileOutputDelimited_9 = "";
    fileName_tFileOutputDelimited_9 = (new java.io.File("D:/DataLake/RawData/salesOrderHeader_"+TalendDate.getDate("YYYY-MM-DD")+".csv")).getAbsolutePath().replace("\\","/");
...
+"r.Comment,\n		SalesLT.SalesOrderHeader.rowguid,\n		SalesLT.SalesOrderHeader.ModifiedDate\nFROM	SalesLT.SalesOrderHeader";
            ...
            if(tmpContent_tDBInput_9 != null) {
            	if (talendToDBList_tDBInput_9 .contains(rsmd_tDBInput_9.getColumnTypeName(8).toUpperCase(java.util.Locale.ENGLISH))) {
            ...
            if(tmpContent_tDBInput_9 != null) {
            	if (talendToDBList_tDBInput_9 .contains(rsmd_tDBInput_9.getColumnTypeName(9).toUpperCase(java.util.Locale.ENGLISH))) {
            ...
            if(tmpContent_tDBInput_9 != null) {
            	if (talendToDBList_tDBInput_9 .contains(rsmd_tDBInput_9.getColumnTypeName(10).toUpperCase(java.util.Locale.ENGLISH))) {
            ...
            if(tmpContent_tDBInput_9 != null) {
            	if (talendToDBList_tDBInput_9 .contains(rsmd_tDBInput_9.getColumnTypeName(14).toUpperCase(java.util.Locale.ENGLISH))) {
            ...
            if(rs_tDBInput_9.wasNull()){
				...
				net.sourceforge.jtds.jdbc.ClobImpl clob_tDBInput_9 = (net.sourceforge.jtds.jdbc.ClobImpl) rs_tDBInput_9.getClob(20);
				if(clob_tDBInput_9!=null){
					net.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_tDBInput_9 = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_tDBInput_9);
					tmpContent_tDBInput_9 = tNTextImpl_tDBInput_9.getValue();
				}else{
					tmpContent_tDBInput_9 = null;				
				}
            if(tmpContent_tDBInput_9 != null) {
            	if (talendToDBList_tDBInput_9 .contains(rsmd_tDBInput_9.getColumnTypeName(20).toUpperCase(java.util.Locale.ENGLISH))) {
	...
	currentComponent="tFileOutputDelimited_9";
                    ...
                    StringBuilder sb_tFileOutputDelimited_9 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_9.append(
                            ...
                            sb_tFileOutputDelimited_9.append(OUT_DELIM_tFileOutputDelimited_9);
                        sb_tFileOutputDelimited_9.append(
                            row9.OnlineOrderFlag
                        );
                            sb_tFileOutputDelimited_9.append(OUT_DELIM_tFileOutputDelimited_9);
                            if(row9.SalesOrderNumber != null) {
                        sb_tFileOutputDelimited_9.append(
                            row9.SalesOrderNumber
                        );
                            }
                            sb_tFileOutputDelimited_9.append(OUT_DELIM_tFileOutputDelimited_9);
                            if(row9.PurchaseOrderNumber != null) {
                        sb_tFileOutputDelimited_9.append(
                            row9.PurchaseOrderNumber
                        );
                            }
                            sb_tFileOutputDelimited_9.append(OUT_DELIM_tFileOutputDelimited_9);
                        ...
                        sb_tFileOutputDelimited_9.append(
                            row9.ShipToAddressID
                        );
                            }
                            sb_tFileOutputDelimited_9.append(OUT_DELIM_tFileOutputDelimited_9);
                            if(row9.BillToAddressID != null) {
                        sb_tFileOutputDelimited_9.append(
                            row9.BillToAddressID
                        );
                            }
                            sb_tFileOutputDelimited_9.append(OUT_DELIM_tFileOutputDelimited_9);
...
String fileName_tFileOutputDelimited_10 = "";
    fileName_tFileOutputDelimited_10 = (new java.io.File("D:/DataLake/RawData/productModel_"+TalendDate.getDate("YYYY-MM-DD")+".csv")).getAbsolutePath().replace("\\","/");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = JobExportRawData.class.getClassLoader().getResourceAsStream("ingestaodados/jobexportrawdata_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = JobExportRawData.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_2.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : JobExportRawData");
        }
