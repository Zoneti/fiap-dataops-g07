...
package ingestaodados.mock_job_for_guess_schema_0_1;
...
// Exception is thrown if db don't support, no need to catch exception here
				...
				java.sql.ResultSet rs = stm.executeQuery(
						"SELECT SalesLT.SalesOrderHeader.SalesOrderID, 		SalesLT.SalesOrderHeader.RevisionNumber, 		convert(varchar(10),SalesLT.SalesOrderHeader.OrderDate,120) OrderDate, 		SalesLT.SalesOrderHeader.DueDate, 		SalesLT.SalesOrderHeader.ShipDate, 		SalesLT.SalesOrderHeader.Status,  		SalesLT.SalesOrderHeader.OnlineOrderFlag, 		SalesLT.SalesOrderHeader.SalesOrderNumber,  		SalesLT.SalesOrderHeader.PurchaseOrderNumber,  		SalesLT.SalesOrderHeader.AccountNumber, 		SalesLT.SalesOrderHeader.CustomerID, 		SalesLT.SalesOrderHeader.ShipToAddressID, 		SalesLT.SalesOrderHeader.BillToAddressID, 		SalesLT.SalesOrderHeader.ShipMethod, 		SalesLT.SalesOrderHeader.CreditCardApprovalCode, 		SalesLT.SalesOrderHeader.SubTotal, 		SalesLT.SalesOrderHeader.TaxAmt, 		SalesLT.SalesOrderHeader.Freight, 		SalesLT.SalesOrderHeader.TotalDue, 		SalesLT.SalesOrderHeader.Comment, 		SalesLT.SalesOrderHeader.rowguid, 		SalesLT.SalesOrderHeader.ModifiedDate FROM	SalesLT.SalesOrderHeader");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File("D:/Programas/Talend/temp/TempGuessSchemaDelimitedFile.csv"))
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class.getClassLoader().getResourceAsStream(
					"ingestaodados/mock_job_for_guess_schema_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 45731 characters generated by Talend Open Studio for Big Data on the 30 de
 * Abril de 2021 22h56min29s BRT
 ************************************************************************************************/